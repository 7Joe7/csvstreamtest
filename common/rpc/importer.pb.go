...
import model1 "github.com/7joe7/csvstreamtest/common/model"
...
func (c *importerClient) ImportClients(ctx context.Context, opts ...grpc.CallOption) (Importer_ImportClientsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Importer_serviceDesc.Streams[0], c.cc, "/rpc.Importer/ImportClients", opts...)
	if err != nil {
		return nil, err
	}
...
type Importer_ImportClientsClient interface {
	...
	CloseAndRecv() (*model1.ImportReport, error)
	grpc.ClientStream
}
...
func (x *importerImportClientsClient) CloseAndRecv() (*model1.ImportReport, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(model1.ImportReport)
...
type Importer_ImportClientsServer interface {
	SendAndClose(*model1.ImportReport) error
...
func (x *importerImportClientsServer) SendAndClose(m *model1.ImportReport) error {
...
func init() { proto.RegisterFile("common/service/importer.proto", fileDescriptor0) }
